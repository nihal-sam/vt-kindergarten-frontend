      ...
      <div className="footer-top" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '32px' }}>
        ...
        <div className="footer-contact-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div className="footer-socials" style={{ justifyContent: 'center' }}>
            <a href="https://wa.me/917358293839" target="_blank" rel="noopener noreferrer" className="social-btn" style={{ background: '#25d366', color: 'white' }} aria-label="WhatsApp">
            ...
            <a href="https://www.instagram.com/vt_kindergarten/" target="_blank" rel="noopener noreferrer" className="social-btn" style={{ background: 'linear-gradient(45deg,#f09433,#dc2743,#bc1888)', color: 'white' }} aria-label="Instagram">
            ...
            <a href="mailto:vtkindergarten@gmail.com" className="social-btn" style={{ background: '#EA4335', color: 'white' }} aria-label="Gmail">
