    ...
    <div className="founder-section" style={{ background: 'var(--light)' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ background: 'white', padding: '40px', borderRadius: 'var(--radius)', boxShadow: 'var(--shadow-soft)', textAlign: 'left', lineHeight: '1.8', fontSize: '16px', color: 'var(--text)' }}>
          ...
          <p style={{ margin: 0 }}>
            By blending Montessori methods with playful learning, they ensure that children not only gain knowledge but also develop confidence, creativity, and a love for learning.
          </p>
        </div>
      </div>
    </div>
